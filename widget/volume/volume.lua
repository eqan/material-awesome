...
local widget_types = {
    icon_and_text = require("widget.volume.widgets.icon-and-text-widget"),
    icon = require("widget.volume.widgets.icon-widget"),
    arc = require("widget.volume.widgets.arc-widget"),
    horizontal_bar = require("widget.volume.widgets.horizontal-bar-widget"),
    vertical_bar = require("widget.volume.widgets.vertical-bar-widget")
}
local volume = {}
